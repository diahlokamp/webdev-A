...
class StoreController extends Controller
{
    ...
    public function insert_product(Request $request)
    {
        ...
        return redirect()->route('shop')->with('success', 'Product inserted successfully!');
    }
    ...
    public function update_product(Request $request, $product_id){
        ...
        return redirect()->route('shop')->with('success', 'Product updated successfully!');
    }
    ...
    public function add_to_cart(Request $request, $product_id){
        ...
        if ($quantity < 1) {
            return redirect()->route('shop')->with('error', 'Quantity must be at least 1.');
        }
        ...
        if ($totalQuantity > $product->stock) {
            return redirect()->route('shop')->with('error', 'Requested total quantity exceeds available stock.');
        }
    ...
    public function checkout(Request $request){
        ...
        try {
            ...
            return redirect()->route('shop')->with('success', 'Checkout successful! Thank you for your purchase.');
		} catch (\Exception $e) {
            DB::rollBack();
